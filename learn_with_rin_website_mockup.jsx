...
import { ArrowRight, CheckCircle2, Sparkles, BookOpen, Download, MessageCircle, PenLine, Laptop, Target, Star, ChevronRight, Gift, Tags, GraduationCap } from "lucide-react";
...
const resources = ["Checklist เริ่มหาเงินจาก AI ใน 7 วัน", "Template วางแผน E-book เล่มแรก", "Prompt Pack สำหรับทำ Digital Product", "Worksheet หาไอเดียรายได้จากทักษะตัวเอง"];
...
const products = [
  {
    ...
    price: "390 บาท",
    oldPrice: "1,590 บาท",
    primaryCta: "ดูรายละเอียดหนังสือ",
  ...
  },
  {
    ...
    bullets: [
      "หาไอเดีย E-book ที่ขายได้",
      "ใช้ ChatGPT ช่วยเขียนแบบมืออาชีพ",
      "จัดหน้า E-book ด้วย Canva",
      "ขายผ่าน Facebook / LINE / เว็บไซต์",
      "ตั้งระบบส่งไฟล์อัตโนมัติ",
    ],
  ...
  },
  {
    ...
    bullets: [
      "เข้าใจ ChatGPT แบบไม่ต้องเป็นสายเทคนิค",
      "เขียน Prompt ให้เอาไปทำเงินต่อได้",
      "10+ ช่องทางหาเงินจาก ChatGPT",
      "สร้างโพสต์ บทความ รีวิว และสคริปต์",
...
export default function LearnWithRinMockup() {
  return (
    <div className="min-h-screen bg-white text-slate-800" style={{ fontFamily: "'Sarabun', 'Noto Sans Thai', sans-serif" }}>
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Sarabun:wght@300;400;500;600;700;800;900&display=swap');`}</style>
      <header className="sticky top-0 z-50 border-b border-sky-100 bg-white/85 backdrop-blur-xl">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
          <div className="flex items-center gap-3">
            <img src={logoSrc} alt="Learn with Rin" className="h-11 w-auto object-contain" />
          </div>
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-b from-white via-[#F4FBFF] to-[#EAF6FF]">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-[1.05fr_.95fr] lg:px-8 lg:py-28">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="relative z-10">
              ...
              <h1 className="max-w-3xl text-4xl font-black leading-tight tracking-tight text-[#123A63] md:text-6xl">
                ใช้ AI ให้เป็น แล้วเริ่มสร้าง <span className="rounded-2xl bg-[#FFE8A3] px-3 text-[#123A63]">รายได้แรก</span> จากสิ่งที่คุณมี
              </h1>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
                Learn with Rin สอนใช้ AI แบบเข้าใจง่าย ไม่ซับซ้อน สำหรับคนที่อยากเริ่มทำ Digital Product, E-book, Template หรือธุรกิจคนเดียวด้วย AI โดยไม่ต้องรอให้พร้อมทุกอย่างก่อน
              </p>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <Button variant="outline" className="h-13 rounded-full border-sky-200 bg-white px-7 text-base font-semibold text-[#123A63] hover:bg-sky-50">
                  ดาวน์โหลด Checklist ฟรี
                </Button>
              </div>
              <div className="mt-8 grid max-w-xl grid-cols-3 gap-4 text-center">
                <div className="rounded-3xl bg-white p-4 shadow-sm">
                  <p className="text-2xl font-black text-[#123A63]">7 วัน</p>
                  <p className="text-xs text-slate-500">เริ่มวางแผนรายได้แรก</p>
                </div>
                <div className="rounded-3xl bg-white p-4 shadow-sm">
                  <p className="text-2xl font-black text-[#123A63]">0 ทุน</p>
                  <p className="text-xs text-slate-500">เริ่มจากสิ่งที่มี</p>
                </div>
                <div className="rounded-3xl bg-white p-4 shadow-sm">
                  <p className="text-2xl font-black text-[#123A63]">AI</p>
                  <p className="text-xs text-slate-500">ช่วยลดเวลาและต้นทุน</p>
                </div>
              </div>
            </motion.div>
                ...
                <div className="rounded-[1.5rem] bg-gradient-to-br from-[#EAF6FF] via-white to-[#DFF3FF] p-6">
                  <div className="mb-5 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Mockup preview</p>
                    </div>
        ...
        <section id="start" className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight text-[#123A63] md:text-5xl">ใช้ AI ทุกวัน แต่ยังไม่รู้จะเอาไปทำเงินยังไง?</h2>
        ...
        <section className="bg-[#F4FBFF] py-20">
          <div className="mx-auto grid max-w-7xl gap-10 px-5 lg:grid-cols-[.9fr_1.1fr] lg:px-8">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black tracking-tight text-[#123A63] md:text-5xl">เราไม่ได้สอนว่า AI เสกเงินได้</h2>
              <p className="mt-5 text-lg leading-8 text-slate-600">
              ...
              <div className="mt-8 rounded-[2rem] bg-white p-6 shadow-sm">
                <p className="text-2xl font-black leading-snug text-[#123A63]">
        ...
        <section id="blog" className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div>
              <p className="font-bold text-[#2F80ED]">SEO Content Hub</p>
              <h2 className="mt-3 text-3xl font-black tracking-tight text-[#123A63] md:text-5xl">บทความเริ่มต้นที่ควรอ่าน</h2>
              <p className="mt-4 max-w-2xl text-lg leading-8 text-slate-600">เนื้อหาสำหรับดึง Organic Traffic จาก Google และพาคนอ่านเข้าสู่ Free Resource หรือ E-book</p>
            </div>
            ...
            {articles.map((article) => (
              <Card key={article.title} className="group overflow-hidden rounded-[1.75rem] border-sky-100 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl hover:shadow-sky-100">
                ...
                <CardContent className="p-6">
                  <h3 className="text-xl font-black leading-snug text-[#123A63]">{article.title}</h3>
        ...
        <section id="free" className="bg-gradient-to-br from-[#123A63] to-[#2F80ED] py-20 text-white">
          <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 lg:grid-cols-[1fr_.9fr] lg:px-8">
            <div>
              ...
              <h2 className="text-3xl font-black leading-tight tracking-tight md:text-5xl">รับไฟล์ฟรีสำหรับเริ่มสร้างรายได้จาก AI ใน 7 วัน</h2>
            ...
            <div className="rounded-[2rem] bg-white p-7 text-slate-800 shadow-2xl shadow-blue-900/20">
              ...
              <div className="mt-6 space-y-3">
                <input className="h-13 w-full rounded-2xl border border-sky-100 bg-[#F8FCFF] px-4 outline-none focus:border-[#4DA3FF]" placeholder="ชื่อของคุณ" />
                <input className="h-13 w-full rounded-2xl border border-sky-100 bg-[#F8FCFF] px-4 outline-none focus:border-[#4DA3FF]" placeholder="อีเมล หรือ LINE ID" />
                <Button className="h-13 w-full rounded-2xl bg-[#4DA3FF] text-base font-bold text-white hover:bg-[#2F80ED]">
                  รับไฟล์ฟรีทันที
                </Button>
              </div>
              <p className="mt-4 text-center text-xs text-slate-500">ไม่มีสแปม ส่งเฉพาะเนื้อหาที่ช่วยให้คุณเริ่มได้จริง</p>
            </div>
          </div>
        </section>
        ...
        <section id="product" className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight text-[#123A63] md:text-5xl">
              สินค้าและคอร์สที่ช่วยให้คุณเริ่มสร้างรายได้ด้วย AI
            </h2>
            <p className="mt-5 text-lg leading-8 text-slate-600">
              เลือกเริ่มจากหนังสือ คอร์สจับมือทำ หรือคอร์สใช้ ChatGPT สร้างรายได้ สำหรับมือใหม่ที่อยากเริ่มจากศูนย์
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <CardContent className="flex h-full flex-col p-7">
                    ...
                    <h3 className="mt-6 text-2xl font-black leading-tight text-[#123A63]">{product.title}</h3>
                    ...
                    <div className="mt-auto pt-7">
                      ...
                      <div className="grid gap-3">
                        <Button className="h-12 rounded-full bg-[#4DA3FF] text-white hover:bg-[#2F80ED]">
                          {product.primaryCta} <ArrowRight className="ml-2 h-4 w-4" />
                        </Button>
                        <Button
                          variant="outline"
                          className="h-12 rounded-full border-sky-200 bg-white text-[#123A63] hover:bg-sky-50"
                          asChild
                        >
            ...
            <div className="grid gap-6 md:grid-cols-[.85fr_1.15fr] md:items-center">
              <div>
                ...
                <p className="mt-3 leading-7 text-slate-600">
                  ถ้าอยากเห็นภาพรวมให้เริ่มจากหนังสือ ถ้าอยากมีสินค้าเป็นของตัวเองให้เลือกคอร์ส E-book และถ้าอยากใช้ ChatGPT ทำงานหาเงินหลายทางให้เลือกคอร์ส ChatGPT
                </p>
              </div>
        ...
        <section className="border-t border-sky-100 bg-white py-16">
          <div className="mx-auto max-w-7xl px-5 text-center lg:px-8">
            ...
            <h2 className="mt-5 text-3xl font-black text-[#123A63] md:text-4xl">เริ่มจากบทความฟรี แล้วค่อยไปให้ถึงรายได้แรก</h2>
            <p className="mx-auto mt-4 max-w-2xl text-lg leading-8 text-slate-600">
              ไม่ต้องรีบซื้ออะไร แค่เริ่มอ่าน เริ่มทำตาม และค่อย ๆ เปลี่ยน AI ให้เป็นเครื่องมือสร้างโอกาสของคุณ
            </p>
      ...
      <footer className="bg-[#123A63] px-5 py-10 text-white lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-6 md:flex-row md:items-center">
          <div>
            <img src={logoSrc} alt="Learn with Rin" className="h-10 w-auto object-contain brightness-0 invert" />
            <p className="mt-2 text-sm text-blue-100">สอนใช้ AI แบบเข้าใจง่าย เพื่อเริ่มสร้างรายได้จากสิ่งที่คุณมี</p>
          </div>
          <div className="flex flex-wrap gap-4 text-sm text-blue-100">
            <a href="#start">เริ่มที่นี่</a>
            <a href="#blog">บทความ</a>
            <a href="#free">ไฟล์ฟรี</a>
            <a href="#product">E-book</a>
