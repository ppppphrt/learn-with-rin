...
const products = [
  ...
  },
  {
    ...
    detailUrl: "/courses/autopost",
    type: "คอร์สออนไลน์สด",
    badge: "Early Bird 50 ท่านแรก",
    icon: PenLine,
    title: "Workflow Auto Post Facebook",
    hook: "โพสต์คอนเทนต์อัตโนมัติ ไม่ต้องนั่งทำเองทุกวัน",
    description: "สร้างระบบ Auto Post ที่ดึงคอนเทนต์จาก Google Sheets, Notion หรือ AI มาโพสต์ลง Facebook ได้เองอัตโนมัติ ลดงานซ้ำๆ เพิ่มความสม่ำเสมอ",
    bullets: ["โพสต์ Facebook อัตโนมัติจาก Google Sheets", "ใช้ AI สร้าง Caption อัตโนมัติ", "ตั้ง Schedule โพสต์ล่วงหน้า", "Multi-Page Posting", "ไม่ต้องเขียนโค้ด"],
    bonuses: ["Workshop สร้าง Workflow จริง", "เครื่องมือ: n8n, Make, ChatGPT", "Final Project"],
    fit: "เหมาะกับเจ้าของธุรกิจ แอดมินเพจ Content Creator และนักการตลาดดิจิทัล",
    price: "1,990 บาท",
    oldPrice: "5,900 บาท",
    checkoutLabel: "สมัครเรียน 1,990 บาท",
    secondaryCta: "ทัก LINE เพื่อสมัครเรียน",
  ...
  },
  {
    ...
    detailUrl: "/courses/website",
    type: "คอร์สออนไลน์สด",
    badge: "Early Bird 50 ท่านแรก",
    icon: Laptop,
    title: "Website for Business",
    hook: "สร้างเว็บไซต์ธุรกิจที่ดูน่าเชื่อถือ พร้อมขาย พร้อมหาลูกค้า",
    description: "เรียนรู้สร้างเว็บไซต์สำหรับธุรกิจตั้งแต่เริ่มต้น วางโครงสร้างที่ช่วยเพิ่มยอดขาย เชื่อมต่อ LINE OA, Facebook และทำ SEO เพื่อให้ลูกค้าค้นหาเจอ โดยไม่ต้องเขียนโค้ด",
    bullets: ["วางโครงสร้างเว็บให้เพิ่มยอดขาย", "สร้าง Landing Page และ Sales Page", "เชื่อมต่อ LINE OA และ Facebook", "พื้นฐาน SEO ให้ลูกค้าค้นหาเจอ", "No-Code ทุกคนทำได้"],
    bonuses: ["Workshop สร้างเว็บไซต์จริง", "Final Project", "6 Module ครบ"],
    fit: "เหมาะกับเจ้าของธุรกิจ SME ร้านค้าออนไลน์ ฟรีแลนซ์ และนักการตลาดดิจิทัล",
    price: "1,990 บาท",
    oldPrice: "5,900 บาท",
    checkoutLabel: "สมัครเรียน 1,990 บาท",
    secondaryCta: "ทัก LINE เพื่อสมัครเรียน",
